...
if(isset($_POST['submitSearch'])) {
    if(false) {
        ...
        if($dateInSearch >= $dateOutSearch || $dateInSearch=="1970-01-01" || $dateOutSearch=="1970-01-01"){
            ...
            $sql = "SELECT roomNumber, checkIn, checkOut FROM reservations AS re JOIN rooms AS ro ON ro.roomID = re.roomID WHERE ro.hotelID=3";
            ...
            $sql = "SELECT roomNumber, roomName, price FROM rooms AS r JOIN roomstypes as t on r.roomType = t.ID WHERE hotelID=3 ORDER BY roomNumber";
