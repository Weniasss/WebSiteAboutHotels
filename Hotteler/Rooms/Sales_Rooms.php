...
if(isset($_GET['id'])){
    ...
    if( $id == 1){
        $sql_1_2 = "SELECT roomName,anons,price,place_picture_1,place_picture_2,services,price FROM roomstypes WHERE pageId = 3";
    }
    else{
        $sql_1_2 = "SELECT roomNamePl as roomName,anonsPl as anons,price,place_picture_1,place_picture_2,services,price FROM roomstypes WHERE pageId = 3";
    }
...
<div class = "sidenav" id = "sidenav">
    ...
    <ul class = "navbar">
        <div class="row">
            ...
            <li><a href="Sales_Rooms.php?id=1" style="text-decoration: none;margin: 15px;"><?php echo $id['1'] ?></a></li>
            <li><a href="Sales_Rooms.php?id=2" style="text-decoration: none;margin: 15px;"><?php echo $id['2'] ?></a></li>
        </div>
    </ul>
</div>
<br>
