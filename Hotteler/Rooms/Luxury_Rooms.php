...
if(isset($_GET['id'])){
    ...
    if( $id == 1){
        $sql_1_2 = "SELECT roomName,anons,price,place_picture_1,place_picture_2,services,price FROM roomstypes WHERE pageId = 2";
    }
    else{
        $sql_1_2 = "SELECT roomNamePl as roomName,anonsPl as anons,price,place_picture_1,place_picture_2,services,price FROM roomstypes WHERE pageId = 2";
    }
...
<div class = "sidenav" id = "sidenav">
    ...
    <ul class = "navbar">
        <div class="row">
            ...
            <li><a href = "Common_Rooms.php?id=<?php echo $id['chose'] ?>"><?php echo $id['common'] ?> <i class="fas fa-home"></i></a></li>
            <br><br><br>

            <h4><?php echo $id['language'] ?> </h4>
            <li><a href="Luxury_Rooms.php?id=1" style="text-decoration: none;margin: 15px;"><?php echo $id['1'] ?></a></li>
            <li><a href="Luxury_Rooms.php?id=2" style="text-decoration: none;margin: 15px;"><?php echo $id['2'] ?></a></li>
        </div>
    </ul>
</div>
<br>
<div class = "head-bottom flex">
    <h2 style="  color: #292826;
            ...
            "><?php echo $id['lux'] ?> <i class="fas fa-coins"></i></h2>
</div>
